...
class ServerStackIconComponent extends HTMLElement {
    constructor() {
        super()
        this.innerHTML = `
            <svg data-slot="icon" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <path clip-rule="evenodd" d="M5.25 13.5a3.75 3.75 0 1 0 0 7.5h13.5a3.75 3.75 0 1 0 0-7.5H5.25Zm10.5 4.5a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm3.75-.75a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" fill-rule="evenodd"></path>
            </svg>`
    }
}
...
customElements.define('revoice-icon-speaker', SpeakerIconComponent);
